...
def load_config_from_env(environ=None, formatter=None):
    if not environ:
        environ = os.environ
    ...
    return formatter(_normalise_environment(environ))

# from https://gist.github.com/michalc/59efee4bde412d137367d44049df8924
def _normalise_environment(key_values):
    ...
    def get_first_component(key):
        return key.split(separator)[0].lower()
    ...
    nested_structured_dict = {
        **without_more_components, **{
            first_component: _normalise_environment(
